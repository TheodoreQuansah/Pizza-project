...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/4l8wfZ
...
ALTER TABLE `inventrory` ADD CONSTRAINT `fk_inventrory_item_id` FOREIGN KEY(`item_id`)
REFERENCES `recipe` (`ing_id`);
